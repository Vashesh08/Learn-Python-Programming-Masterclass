...
# for k in [(i, i*j) for i in range(1, 11) for j in range(1, 11)]:
#     print(k[0], k[1])
print(((i, i*j) for i in range(1, 11) for j in range(1, 11)))
for k in ((i, i*j) for i in range(1, 11) for j in range(1, 11)):
    print(k[0], k[1])

# for value in [[(j, i*j) for i in range(1, 11)] for j in range(1, 11)]:
#     for val in value:
#         print(val[0], val[1])
