...
class Vampyre(Enemy):
    ...
    def __init__(self, name):
        super(Vampyre, self).__init__(name=name, hit_points=12, lives=3)
        # Enemy.__init__(self, name=name, hit_points=12, lives=3)
...
class VampyreKing(Vampyre):
    ...
    def take_damage(self, damage):
        super(VampyreKing, self).take_damage(damage=damage//4)
