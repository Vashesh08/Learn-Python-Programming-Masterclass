...
class DocType(Tag):
    ...
    def __init__(self):
        super(DocType, self).__init__('!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN" http://www.w3.org/TR/html4/strict.dtd', '')
...
class Head(Tag):
    ...
    def __init__(self, title_contents=''):
        ...
        self.contents = Tag('title', title_contents)


class Body(Tag):

    def __init__(self):
        super(Body, self).__init__('body', '')  # body content will be built up separately
        self._body_contents = []
...
if __name__ == '__main__':
    # my_page = HtmlDoc('Hello there, mate!')
    # my_page.add_tag('h1', 'Main Heading')
    # my_page.add_tag('h2', 'subheading')
    # my_page.add_tag('p', 'This is the paragraph on the page')
